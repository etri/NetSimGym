...
from NetSimGym.netsimenv2 import NetSimEnv2
import os
import numpy as np
...
timestep = 0.2
totaltime = 30
State_list = ["CellLoad_ex2"]
State_device_list = ["gNB"]
State_device_range_list = [[9, 15]]
Action_list = ["HOM"]
Reward_list = ["Dummy"]
Reward_device_list = ["UE"]
Reward_device_range_list = [[16, 16]]
obs_space_list = [[0, 2, 7]]
max_delta = 0.4
...
def env_creator(env_config):
    ...
    env_config['max_delta'] = max_delta
    env = NetSimEnv2(env_config=env_config)
    return env
